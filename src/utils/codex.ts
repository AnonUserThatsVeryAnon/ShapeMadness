...
export const ENEMY_CARDS: Record<EnemyType, EnemyCard> = {
  ...
  [EnemyType.ARCHITECT]: {
    ...
    name: 'The Architect',
    description: '⚠️⚠️ FINAL BOSS ⚠️⚠️ - The reality manipulator itself. A god-like entity that bends space and constructs deadly arenas. The ultimate endgame challenge with three mind-bending phases. Only the most skilled players will prevail.',
    abilities: [
      '⚠️⚠️ FINAL BOSS - 12000 HP ⚠️⚠️',
      'PHASE 1 - CONSTRUCTION (100-66%):',
      '  • Spawns destructible walls that divide the arena (2-4 walls every 8s, 100 HP each)',
      '  • Teleports around the player (250-350 unit range)',
      '  • Fires 3 homing projectiles every 3s',
      '  • Walls can be destroyed with bullets',
      'PHASE 2 - DECONSTRUCTION (66-33%):',
      '  • Boss becomes INVULNERABLE and splits into 3 fragments',
      '  • ALL 3 fragments must be damaged - damage is shared',
      '  • Fragments orbit center position',
      '  • Walls rotate continuously',
      '  • Laser beams connect all fragments (6 damage/s)',
      'PHASE 3 - RECONSTRUCTION (33-0%):',
      '  • Boss reforms at center, fully vulnerable',
      '  • Spawns 2 ELITE enemies every 5s (Lufti, Evil Storm, Time Distortion, Magician)',
      '  • Triple shockwave rings (15 damage each, 200 radius) every 4s',
      '  • Ring of 8 shooters spawn every 2s (bullet hell pattern)',
      '  • Slow but incredibly deadly',
      'Huge 45 radius hitbox',
      '40 contact damage',
      'Epic phase transitions with massive screen shake',
      'Spawns alone at round 30'
    ],
    stats: {
      health: ENEMY_CONFIGS[EnemyType.ARCHITECT].health,
      speed: ENEMY_CONFIGS[EnemyType.ARCHITECT].speed,
      damage: ENEMY_CONFIGS[EnemyType.ARCHITECT].damage,
      value: ENEMY_CONFIGS[EnemyType.ARCHITECT].value,
    },
    unlockRound: 30,
    discovered: false,
    color: ENEMY_CONFIGS[EnemyType.ARCHITECT].color,
    icon: '🏗️',
    tips: [
      '⚠️⚠️ THIS IS THE FINAL BOSS! ⚠️⚠️',
      'MAX OUT all upgrades before round 30',
      'Phase 1: Destroy walls to create escape routes',
      'Phase 1: Bait teleports to control positioning',
      'Phase 2: Focus fire on one fragment at a time',
      'Phase 2: Dodge between laser connections',
      'Phase 3: Kill elite spawns immediately',
      'Phase 3: Dodge between shockwave rings',
      'Phase 3: Stay moving during bullet hell patterns',
      'Piercing shots help with walls and minions',
      'Multi-shot is crucial for clearing adds',
      'High fire rate = faster phase transitions',
      'Defeating grants 500 money - ultimate reward!',
      'Master your dash ability (Round 15+)',
